      ...
      <div className=" bg-white relative dark:bg-slate-900 dark:text-white text-slate-950 flex items-center w-full justify-center flex-col">
        ...
        <div className="container px-4 mb-8 z-20">
          ...
          <p>
            ...
            use of Co-Create Hub &#x27;s Website, located at
            <a
              className="text-blue-500 underline"
              href="https://cp-create-hub.netlify.app"
            >
              https://cp-create-hub.netlify.app.
            </a>
          </p>
          <p>
          ...
          <p>
            ...
            , you agreed to use cookies in agreement with the Co-Create
          ...
          <h3>License</h3>
          <p>
            Unless otherwise stated, Co-Create Hub and/or its licensors own the
          ...
          <p>
            ...
            Co-Create Hubdoes not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions ofCo-Create Hub, its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Co-Create
          ...
          <p>
            Co-Create Hub reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Co-Create Hub a non-exclusive license to use,
          ...
          <ul class="type-alpha">
            ...
            <li>
              ...
              the absence of Co-Create Hub; and
            </li>
          ...
          <p>
            ...
            sending an e-mail to Co-Create Hub. Please include your name, your
          ...
          <p>
            No use of Co-Create Hub&#x27;s logo or other artwork will be allowed
